...
def run():
    ...
    myButton = tk.Button(root,text="Generate Stagnant Amount", command=stag,fg="black",bg="#d7f542",width=25,border=0,activeforeground="blue",activebackground="black",font="lucida 15 bold")
